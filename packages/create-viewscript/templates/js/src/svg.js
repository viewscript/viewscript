 ...
 * @returns {Array<Object>} Array of PathCommand objects suitable for WASM tessellation
 */
 ...
 *
 * @param {Array<Object>} commands - Array of PathCommand objects
 * @returns {string} JSON string suitable for FontRegistry.tessellate_svg_path()
 */
export function pathCommandsToJson(commands) {
 ...
 * @returns {string} JSON string suitable for FontRegistry.tessellate_svg_path()
 */
export function svgPathToJson(d) {
